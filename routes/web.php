...
Route::get('/disclaimer', function () {
    ...
    return view('disclaimer', compact('disclaimerPage', 'disclaimerNote'));
})->name('disclaimer');
...
Route::prefix('adminslair')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'not.banned', 'admin'])->group(function () {
        ...
        Route::get('/pages/disclaimer', [SitePageController::class, 'editDisclaimer'])->name('pages.disclaimer.edit');
        Route::put('/pages/disclaimer', [SitePageController::class, 'updateDisclaimer'])->name('pages.disclaimer.update');
